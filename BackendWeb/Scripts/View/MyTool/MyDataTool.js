...
class MyDateTool {
    ...
    MDDateToTenDayNo(MDdate) {
        return DateToTenDayNo("2020-" + MDdate);
    }
...
`;
    ...
    GetPopoverTenDaysTxtValArry(row = 1, col = 36, page = 1) {
        let init = [
            { txt: '第1旬', val: 1 }, { txt: '第2旬', val: 2 }, { txt: '第3旬', val: 3 }, { txt: '第4旬', val: 4 },
            { txt: '第5旬', val: 5 }, { txt: '第6旬', val: 6 }, { txt: '第7旬', val: 7 }, { txt: '第8旬', val: 8 },
            { txt: '第9旬', val: 9 }, { txt: '第10旬', val: 10 }, { txt: '第11旬', val: 11 }, { txt: '第12旬', val: 12 },
            { txt: '第13旬', val: 13 }, { txt: '第14旬', val: 14 }, { txt: '第15旬', val: 15 }, { txt: '第16旬', val: 16 },
            { txt: '第17旬', val: 17 }, { txt: '第18旬', val: 18 }, { txt: '第19旬', val: 19 }, { txt: '第20旬', val: 20 },
            { txt: '第21旬', val: 21 }, { txt: '第22旬', val: 22 }, { txt: '第23旬', val: 23 }, { txt: '第24旬', val: 24 },
            { txt: '第25旬', val: 25 }, { txt: '第26旬', val: 26 }, { txt: '第27旬', val: 27 }, { txt: '第28旬', val: 28 },
            { txt: '第29旬', val: 29 }, { txt: '第30旬', val: 30 }, { txt: '第31旬', val: 31 }, { txt: '第32旬', val: 32 },
            { txt: '第33旬', val: 33 }, { txt: '第34旬', val: 34 }, { txt: '第35旬', val: 35 }, { txt: '第36旬', val: 36 },
